...
export function SketchFlowEmbed({
  ...
  const practiceHref =
    src ??
    "/practice/sketchflow?topic=" +
      encodeURIComponent(title.replace(" — practice canvas", "")) +
      "&prompt=" +
    ...
    <section className="sketchflow-embed-card">
      <div className="sketchflow-embed-head">
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          <a href={practiceHref} target="_blank" rel="noreferrer" className="sketchflow-embed-action">
          ...
          <Button
            ...
            aria-label={fullscreen ? "Exit practice fullscreen" : "Open practice fullscreen"}
          >
